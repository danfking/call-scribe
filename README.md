...
The loopback capture records the **default output device**. If you take calls on a headset, make the headset your Windows default output before recording, and don't switch output devices mid-call. If you use mic-monitoring software that routes your microphone into your output mix, your own voice will bleed into the "Others" track; route the monitor mix away from the default output.
